<base href="">
		<meta charset="utf-8" />
		<title>Hafara Cantik Indonesia</title>
		...
		<link href="{{ asset('assets/backend/css/themes/layout/brand/light.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ asset('assets/backend/css/themes/layout/aside/light.css') }}" rel="stylesheet" type="text/css" />
