            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap py-3">
                   <div class="card-title">
                        <span id="title-tabel"></span>
                       
                   </div>
                   
                    <div class="card-toolbar">
                        <form action="{{ route('onhand.excel') }}" method="POST">
                            @csrf
                            <input type="hidden" name="tanggal_excel" id="tanggal_excel">
                            <input type="hidden" name="tahun_excel" id="tahun_excel">
                    ...
                    <table class="table table-bordered" id="user_table">
                        <thead>
                            <tr>
                                ...
                                <th>Kode Barang</th>
                                <th>Nama Barang</th>
                                <th>Starting Inventory (Kg)</th>
                                <th>In (Kg)</th> 
                                <th>Out (Kg)</th>
                                <th>Ending Inventory (Kg)</th>
                                <th>Ending Inventory (Roll)</th>
                                <th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
...
<script>
    ...
    $('#tanggal_excel').val(input_tanggal);
    $('#tahun_excel').val(input_tahun);
    ...
    function renderTable(bulan,tahun){
        $('#user_table').DataTable({
            ...
            columns: [
                ...
                {data: 'in_kg', name: 'in_kg'},
                {data: 'out_kg', name: 'out_kg'},
                {data: 'ending_kg', name: 'ending_kg'},
                {data: 'ending_rol', name: 'ending_rol'},
